...
public:
	...
	bool		BindParam(int32 paramIndex, uint32* value, SQLLEN* index);
	bool		BindParam(int32 paramIndex, int64* value, SQLLEN* index);
	bool		BindParam(int32 paramIndex, uint64* value, SQLLEN* index);
	...
	bool		BindCol(int32 columnIndex, uint32* value, SQLLEN* index);
	bool		BindCol(int32 columnIndex, int64* value, SQLLEN* index);
	bool		BindCol(int32 columnIndex, uint64* value, SQLLEN* index);
