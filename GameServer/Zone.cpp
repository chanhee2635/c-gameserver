...
void Zone::AddPendingSpawn(CreatureRef creature) { _pendingSpawns.push_back(creature); }
void Zone::AddPendingMove(CreatureRef creature)  { _pendingMoves.push_back(creature); }
